...
<form action="" method="post" enctype="multipart/form-data">
    ...
    Tên sách (*): <input type="text" name="name" value="<?php echo $book['name']?>" />
    <br />
    Số lượng sách: <input type="number" name="amount" value="<?php echo $book['amount']?>" />
    <br />
    Ảnh đại diện: <input type="file" name="avatar" />
    <?php if(!empty($book['avatar'])) :?>
    <img src="assets/uploads/<?php echo $book['avatar']?>" alt="" height="40px"/>
    <?php endif;?>
    <br />
    <input type="submit" value="Lưu" name="submit" />
    <input type="reset" value="Reset" />
    <a href="index.php">Back ve danh sách</a>>
</form>
