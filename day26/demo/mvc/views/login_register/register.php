                    ...
                    <div class="p-5">
                        ...
                        <form class="user" action="" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="password" class="form-control form-control-user" id="exampleRepeatPassword" name="re-password" placeholder="Repeat Password">
                                </div>
                            </div>
                            ...
                            <hr>
                            <a href="<?php echo $login_button?>" class="btn btn-google btn-user btn-block">
                                <i class="fab fa-google fa-fw"></i> Register with Google
                            </a>
                            <a href="<?php echo htmlspecialchars($loginUrl)?>" class="btn btn-facebook btn-user btn-block">
